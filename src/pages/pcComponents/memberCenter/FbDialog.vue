        ...
        toLink: function(appid) {
            ...
            if(this.platFormType == "facebook") {
                if (navigator.userAgent.match(/(phone|pad|pod|iPhone|iPod|ios|iPad|Android|Mobile|BlackBerry|IEMobile|MQQBrowser|JUC|Fennec|wOSBrowser|BrowserNG|WebOS|Symbian|Windows Phone)/i)) {
                    // 移动端
                    this.url = "https://sdk.gamemorefun.com/mobile/v1/passport/facebook/5?app_id="+ appid +"&redirect_url=https%3A%2F%2Fwww.hermesgames.com.tw%2F%23%2Fmobile%2Fhome";

                } else {
                    // PC端
                    this.url = "https://sdk.gamemorefun.com/mobile/v1/passport/facebook/5?app_id="+ appid +"&redirect_url=https%3A%2F%2Fwww.hermesgames.com.tw%2F%23%2Fpc%2Fhome";
                }
            }
            ...
            if(this.platFormType == "google") {
                ...
                if (navigator.userAgent.match(/(phone|pad|pod|iPhone|iPod|ios|iPad|Android|Mobile|BlackBerry|IEMobile|MQQBrowser|JUC|Fennec|wOSBrowser|BrowserNG|WebOS|Symbian|Windows Phone)/i)) {
                    this.url = "https://sdk.gamemorefun.com/rest/v2/passport/google/5?app_id="+ appid +"&redirect_url=https%3A%2F%2Fwww.hermesgames.com.tw%2F%23%2Fmobile%2Fhome";
                } else {
                    this.url = "https://sdk.gamemorefun.com/rest/v2/passport/google/5?app_id="+ appid +"&redirect_url=https%3A%2F%2Fwww.hermesgames.com.tw%2F%23%2Fpc%2Fhome";
                }
            }
            ...
            if(this.platFormType == "apple") {
                ...
                if (navigator.userAgent.match(/(phone|pad|pod|iPhone|iPod|ios|iPad|Android|Mobile|BlackBerry|IEMobile|MQQBrowser|JUC|Fennec|wOSBrowser|BrowserNG|WebOS|Symbian|Windows Phone)/i)) {
                    // mobile
                    this.url = "https://sdk.gamemorefun.com/rest/v2/passport/apple/5?app_id="+ appid +"&redirect_url=https%3A%2F%2Fwww.hermesgames.com.tw%2F%23%2Fmobile%2Fhome";
                } else {
                    // pc
                    this.url = "https://sdk.gamemorefun.com/rest/v2/passport/apple/5?app_id="+ appid +"&redirect_url=https%3A%2F%2Fwww.hermesgames.com.tw%2F%23%2Fpc%2Fhome";
                }
            }
